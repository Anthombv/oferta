  ...
  return (
    <>
      <div style={{ backgroundColor: "yellow", position: "relative"}}>
        <h2 className="text-center text-3xl font-normal leading-normal mt-4 mb-2 text-red-800">
        ...
        <form className="m-2">
          ...
          <div className="grid grid-cols sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-4 gap-2 sm:gap-2 md:gap-2 lg:gap-2 xl:gap-2">
            ...
            <div className="relative z-0 mb-2 w-full group">
              ...
              <select
                id=""
                defaultValue="Marculino"
                className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
              >
                <option selected>Seleccion el sexo del cliente</option>
