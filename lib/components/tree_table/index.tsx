...
const allButtons = (buttons?: TableButtons, defaultActions?: DefaultActions) => {
  return (
    buttons ? (
      //@ts-ignore
      ...
      <Column type="buttons" caption="Acciones">
        <Button name="edit" hint="editar" text="editar" icon="/edit.svg" />
        <Button name="delete" hint="eliminar" text="eliminar" icon="/delete.svg" />
        <Button name="save" hint="guardar" text="guardar" icon="/save.svg" />
        <Button name="cancel" hint="cancelar" text="cancelar" icon="/cancel.svg" />
      </Column>
    ))
  );
}
