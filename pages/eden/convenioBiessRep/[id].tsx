...
const ConvenioBiessREP = ({ oneOfert, ofertID }) => {
  const { auth } = useAuth();
  ...
  class DocumentCreator {
    ...
    public createFirmas2rep(): Paragraph {
      return new Paragraph({
        children: [
          new TextRun({ text: "En representación del señor/a", bold: true }),
        ],
      });
    }
...
export default ConvenioBiessREP;
