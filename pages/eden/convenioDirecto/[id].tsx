    ...
    public createTextAntecedente3pt1(): Paragraph {
      return new Paragraph({
        ...
        children: [
          ...
          new TextRun(
            ". En caso de que exista un cambio en el plan de pagos se considerara el precio real del inventario. Este valor será cancelado de acuerdo a la tabla de pagos (Anexo 1) que forma parte integral del mismo."
          ),
        ],
      });
    }
