            ...
            children: [
              ...
              new Paragraph({
                ...
                children: [
                  ...
                  new TextRun(
                    ", por sus propios derechos, conforme consta en los documentos que se adjunta como habilitantes; a quien se le denominará FUTUROS ADQUIRIENTES; y"
                  ),
                ],
              }),
    ...
    public createTextAntecedente3pt1(): Paragraph {
      return new Paragraph({
        ...
        children: [
          ...
          new TextRun(
            ". En caso de que exista un cambio en el plan de pagos se considerará el precio real del inventario. Este valor será cancelado de acuerdo a la siguiente tabla de pagos (Anexo 1) que forma parte integral del mismo."
          ),
        ],
      });
    }
