...
const ConvenioBiessREP = ({ oneOfert, ofertID }) => {
  ...
  class DocumentCreator {
            ...
            children: [
              ...
              new Paragraph({
                ...
                children: [
                  ...
                  new TextRun(
                    ", conforme consta en los documentos que se adjuntan como habilitantes; a quienes se les denominará FUTUROS ADQUIRIENTES; y"
                  ),
                ],
              }),
    ...
    public createFirmas2rep(): Paragraph {
      return new Paragraph({
        children: [new TextRun("En representación de el/la señor/a")],
      });
    }
