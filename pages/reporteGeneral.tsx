              ...
              {inmueblesEJ.length > 0 && (
                <>
                  <tr>
                    <td
                      colSpan={7}
                      className="font-bold text-xs py-2 text-center"
                    >
                  ...
                  {inmueblesEJ.map((item, index) => {
                    ...
                    const [dia, mes, anio] = fechaParte.split("/");
                    const mess = parseInt(mes) < 10 ? "0" + mes : mes;
                    const dias = parseInt(dia) < 10 ? "0" + dia : dia;
                    const fechaFormateada = `${dias}/${mess}/${anio}`;
                    return (
                      <tr
                        key={index}
