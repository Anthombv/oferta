...
const Convenio = ({ oneOfert, ofertID }) => {
  ...
  const preciofinaR = (precioFinal.toLocaleString())
  ...
  const generate = () => {
    ...
    Packer.toBlob(doc).then((blob) => {
      console.log(blob);
      fileSaver.saveAs(blob, "convenio.docx");
  ...
  return (
    <>
      <div>
        <p>
          <button onClick={generate}>Generar Convenio</button>
        </p>
      </div>
    </>
  );
