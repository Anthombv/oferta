...
const ReportOfertED = ({ oneOfertED, ofertID }) => {
  ...
  return (
    ...
    <div className="print-oferta">
      ...
      <img className="logo-print mx-5 my-2" src="http://grupoancon.com/wp-content/uploads/2020/07/logo-empresa-slide-1-min.png" alt="logo" />
        <button
          onClick={handlePrint}
      ...
      <div className="tabla-oferta container mx-auto block xl:mx-auto bg-white w-min mt-20 mb-3">
        <div className={styles.hoja}>
          {(oneOfertED.data ?? []).map((item, index) => {
            ...
            return (
              <div className="text-sm text-gray-800" ref={componentRef} key={index}>
