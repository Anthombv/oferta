...
const ConvenioDirectoREP = ({ oneOfert, ofertID }) => {
  ...
  class DocumentCreator {
    ...
    public createFirmas2rep(): Paragraph {
      return new Paragraph({
        children: [
          new TextRun({ text: "En representación de el/la señor/a", bold: true }),
        ],
      });
    }
